...
<script type="text/javascript" src="https://www.jqueryscript.net/demo/Responsive-WYSIWYG-Text-Editor-with-jQuery-Bootstrap-LineControl-Editor/editor.js"></script>
<link rel="stylesheet" type="text/css" href="https://www.jqueryscript.net/demo/Responsive-WYSIWYG-Text-Editor-with-jQuery-Bootstrap-LineControl-Editor/editor.css">
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  ...
                  <div>
                    <fieldset>
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" checked="" value="0" name="tab" id="customRadio1" value="igotnone">
                  ...
                  <div>
                    <fieldset>
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="tab" id="customRadio2" value="1" >
                     ...
                     <fieldset>
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="tab" id="customRadio3" value="2" >
                        <label class="custom-control-label" for="customRadio3">All Owners</label>
                      </div>
                    </fieldset> 
                  </div>&nbsp;&nbsp;&nbsp;
                      <div>
                     ...
                     <fieldset>
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="tab" id="customRadio4" value="3" >
                        <label class="custom-control-label" for="customRadio4">All Travelers</label>
                      </div>&nbsp;&nbsp;&nbsp;
                    </fieldset>
                      </div>
                      <div>
                     <fieldset>
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" name="tab" id="customRadio5" value="4" >
                        <label class="custom-control-label" for="customRadio5">All Agencies</label>
                      </div>
                    </fieldset>
                  </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 col-lg-9" style="width:80%">
                            <select class="select2 form-control" name="email[]" multiple="multiple" style="width: 100%">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="projectinput4" required class="form-control" placeholder="Subject" name="subject">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <textarea name="message" required="" id="txtEditor" rows="10" cols="95"></textarea> 
                          </div>
                        </div>
                        </div>
