                         ...
                         <tbody>
                          ...
                          <tr>
                           <td>
                            ...
                            <td>
                              <a href="{{url('admin/reservations-details/')}}/{{$booking->booking_id}}" class="button btn btn-icon btn-success mr-1"><i class="ft-file"></i></a>
                              {{-- <button type="button" class="btn btn-icon btn-success mr-1"><i class="ft-message-square"></i></button> --}}
                            </td>
                            <td style="min-width: 110px;">
                                <fieldset class="form-group">
                                  <select class="form-control" onchange="status_update('{{$booking->booking_id}}',this.value)" id="basicSelect" style="cursor: pointer;">
