...
class GenerateDwollaAccessToken extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dwolla:generate_access_token';
     ...
     * @var string
     */
    protected $description = 'Generates dwolla access token';
    ...
    {
        $accessTokenInConfig = config('services.dwolla.access_token');
        if (!$accessTokenInConfig) {
            Logger::info('Generating new accessToken for Dwolla from Generate Command:');
