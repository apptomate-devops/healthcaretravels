...
<div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Cities Management</h3> <span style="float:right"><button type="button" class="btn btn-outline-blue blue block btn-lg" data-toggle="modal" data-target="#rollIn">
                            Add Cities
                          </button></span>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      ...
                                      <input type="text" required name="title" value="" class="form-control" id="title" placeholder="Title">
                                    </fieldset>
                                    <fieldset class="form-group floating-label-form-group">
                                      <label for="email">Location</label>
                                      <input type="text" required name="location" value="" class="form-control" id="location" placeholder="Location">
                                    </fieldset>
                                    <fieldset class="form-group floating-label-form-group">
                                      <label for="email">Category Id</label>
                                      <input type="text" required name="category_id" value="1" class="form-control" id="category_id" placeholder="Category Id">
                                    </fieldset>
                                    <fieldset class="form-group floating-label-form-group">
                        ...
                        <tbody>
                          ...
                          @foreach($data as $key=> $d)
                            ...
                            <tr>
                              ...
                              <td>
                                <a class="btn btn-default btn-info btn-block" data-toggle="modal" data-target="#rollIn{{$key+1}}" style="color:white"><i class="fa fa-edit"></i>Edit</a>
                                <a class="btn btn-default btn-danger btn-block" href="delete-city/{{$d->id}}" style="color:white"><i class="fa fa-edit"></i>Delete</a>
                              </td>
                            </tr>
@endforeach
                        </tbody>
