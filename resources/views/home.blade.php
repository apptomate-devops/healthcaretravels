...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="parallax home-slide" data-background="/background.jpg" data-color="#36383e" data-color-opacity="0.5" data-img-width="2500" data-img-height="1600">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              ...
              <!-- Main Search Input  -->
                <div class="col-md-4 col-sm-6 col-xs-12" style="margin-top: 10px;">
                  <div class="main-search-input">
                    <input type="text" required id="pac-input" name="search_addr" placeholder="Enter address e.g. street, city or state" value=""/>
                  </div>
                </div>
               ...
               <!-- Status  -->
                 <div class="col-md-2 col-sm-6 col-xs-6" style="margin-top: 10px;">
                  <select name="property_type" required data-placeholder="Any Status" class="chosen-select-no-single" >
  ...
  <div class="container">
              ...
              <div class="listing-item compact">
                <a href="{{url('/')}}/property/{{$property->property_id}}" class="listing-img-container">
                  ...
                  <div class="listing-img-content">
                    ...
                    <span onclick="favourite({{$property->property_id}});"  class="like-icon with-tip" data-tip-content="Add to Favorites"></span>
                    @else
                    <span onclick="favourite({{$property->property_id}});"  class="like-icon with-tip liked" data-tip-content="Remove from Favorites"></span>
                    @endif
        ...
        <!-- Listing Item -->
          ...
          <div class="listing-item">
              ...
              <div class="listing-img-content">
                <span class="listing-price">$ {{$property->price_more_than_one_month}}/Month</i></span>
                 @if(Session::get('user_id'))
                  <span @if($property->is_favourite == "0") class="like-icon with-tip" @else class="like-icon with-tip liked" @endif data-tip-content="Add to Favorites" onclick="favourite({{$property->property_id}})"></span>
            ...
            <div class="listing-content">
              ...
              <a href="{{url('/')}}/property/{{$property->property_id}}" class="listing-address popup-gmaps">
              ...
              <div class="listing-footer">
                <a href="{{url('/')}}/owner-profile/{{$property->owner_id}}"><i class="fa fa-user"></i> {{$property->first_name}} {{$property->last_name}}</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="headline centered margin-bottom-35 home-h3" style="margin-top: -100px;">Featured Places <span>Search for your next short-term housing by City and State</span></h3>
        </div>


        <?php $i = 0; ?>
        @foreach($categories as $category)
                @if($i==0 || $i==7 || $i==8 || $i==12) <div class="col-md-4"> @endif
                @if($i==1 || $i==6 || $i==9 || $i==13) <div class="col-md-4"> @endif
                @if($i==2 || $i==5 || $i==10 || $i==14) <div class="col-md-4"> @endif
                @if($i==3 || $i==4 || $i==11 || $i==15) <div class="col-md-8"> @endif
                @if($i < count($categories))
                <!-- Image Box -->
                <a href="{{url('/')}}/short-term?place={{$category->title}}" class="img-box" @if($i==0 || $i==4 || $i==11 || $i==15 || $i==5) style="height: 525px;" @endif @if($i==3 || $i==7 || $i==8 ||$i==12) style="height: 250px;" @endif data-background-image="{{$category->image_url}}">
                <!-- Badge -->
                <div class="listing-badges">
      ...
      <div class="row">
            <div class="col-md-12">
              ...
              <form action="" method="" name="subscribe">
                <div class="form-row">
                  <input type="text" placeholder="Email Address" class="form-control" name="email_subscribe" id="email_subscribe">
                  <button class="form-control btn-small btn-primary" name="subscribe" id="subscribe">Subscribe</button>
                </div>
              </form>
            </div>
        </div>
