...
.star-rating .fa-star{color: #e78016;}
</style>
      ...
      <div class="content-header row">
        ...
        <!-- <div class="content-header-right col-md-6 col-12">
          ...
          @if($property[0]->verified==0)
              <a style="float:right"  class="btn btn-default btn-danger btn-block" href="{{BASE_URL}}admin/verify_property/{{$property[0]->property_id}}"><span >Click here to Verify This Property </span></a>
              @else
      ...
      <div class="col-md-12 ">
        ...
        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              ...
              <tr>
                <td>Location</td>
                <td><b>{{$property[0]->address}},{{$property[0]->city}},{{$property[0]->state}},{{$property[0]->state}}-{{$property[0]->zip_code}}</b></td>
                <td>Property Type</td>
                <td><b>{{$property[0]->room_type}}</b></td>
              </tr>
              <tr>
                <td>Booking Type</td>
                <td><b>{{$property[0]->is_instant==1?'Instant Booking' :'Request Booking'}}</b></td>
            ...
            <table class="table table-xl mb-0">
              ...
              <tr>
               ...
               <tr>
                ...
                <td><b>@if($property[0]->is_extra_guest==1){{CURRENCY}} {{$property[0]->price_per_extra_guest}}/Priceper extra guest @else No Extra Guest Allowed @endif</b></td>
          ...
          <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
           @if(!empty($property->images))
                  @foreach($property->images as $img)
                    <a href="{{$img->image_url}}" target="_blank" itemprop="contentUrl" data-size="480x360"><img class="img-thumbnail img-fluid" src="{{$img->image_url}}"
                        itemprop="thumbnail" alt="Image description" height="25%" width="25%"></a>
                    @endforeach
             @endif
          </div>
