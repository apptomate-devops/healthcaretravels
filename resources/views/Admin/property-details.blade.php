    ...
    <div class="content-header row">
        ...
        @if($property[0]->verified==0)
            <a style="float:right" class="btn btn-default btn-danger btn-block"
               href="{{BASE_URL}}admin/verify_property/{{$property[0]->property_id}}"><span>Click here to Verify This Property </span></a>
        @else
                        ...
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                                   role="tab" aria-controls="nav-home" aria-selected="true">Property Details</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                   role="tab" aria-controls="nav-profile" aria-selected="false">Amenties</a>
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                                   role="tab" aria-controls="nav-contact" aria-selected="false">Pricing Details</a>
                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about"
                                   role="tab" aria-controls="nav-about" aria-selected="false">Property Images</a>
                                <a class="nav-item nav-link" id="nav-about-owner" data-toggle="tab" href="#nav-owner"
                                   role="tab" aria-controls="nav-owner" aria-selected="false">Owner Details</a>
                            </div>
                        </nav>
...
{{--                                    </tr>--}}
                                    ...
                                    <tr>
                                        <td>Extra Guest Fees</td>
                                        <td>
                                            <b>@if($property[0]->is_extra_guest==1){{CURRENCY}} {{$property[0]->price_per_extra_guest}}
                                                /Priceper extra guest @else No Extra Guest Allowed @endif</b></td>
                            ...
                            <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                @if(!empty($property->images))
                                    @foreach($property->images as $img)
                                        <a href="{{$img->image_url}}" target="_blank" itemprop="contentUrl"
                                           data-size="480x360"><img class="img-thumbnail img-fluid"
                                                                    src="{{$img->image_url}}"
