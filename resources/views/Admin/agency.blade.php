                        ...
                        <tbody>
                          ...
                          @foreach($agencyes as $key => $agency)
                            <tr>
                              ...
                              <td>
                                <center>@if($agency->name_of_agency!='0'){{$agency->name_of_agency}} @else - @endif </center>
                                
                             
                              </td>
                              <td>
                                @if($agency->email!='0'){{$agency->email}}@else <center>-</center>@endif
                              </td>
                              <td>
                                @if($agency->phone!='0'){{$agency->phone}}@else <center>-</center>@endif
                              </td>
                             
                             
                               <td>
                                @if($agency->is_verified==0)
                             ...
                             <td>
                                <fieldset class="form-group">
                                  <select class="form-control" onchange="status_update(this.value,{{$agency->id}})" id="basicSelect" style="cursor: pointer;">
