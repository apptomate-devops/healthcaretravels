                                ...
                                <table class="table table-striped table-bordered zero-configuration select" id="hct_users">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($traveller->phone!='0')
                                                <span class="masked_phone_us_text">{{$traveller->phone}}</span>
                                                @else
                                                <center>-</center>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if($traveller->approved_by)
                                                <a href="{{BASE_URL}}admin/single_user?id={{$traveller->id}}"><span class="btn btn-outline-success btn-default btn-block">Documents Approved </span> </a>
                                                @else
                                                <a href="{{BASE_URL}}admin/single_user?id={{$traveller->id}}"><span class="btn btn-success btn-default btn-block">View </span> </a>
                                                @endif
                                            </td>
                                            <td>
                                                <fieldset class="form-group">
                                                    <select class="form-control" onchange="status_update(this.value,{{$traveller->id}},this)" id="basicSelect" style="cursor: pointer;">
