    ...
    <li {{{ (Request::is('admin/request_roommate*') ? 'class=active' : '') }}}>
      ...
      <!--   <li {{{ (Request::is('admin/refunds*') ? 'class=active' : '') }}}>
        ...
        <li {{{ (Request::is('admin/cancellation-policy*') ? 'class=active' : '') }}}>
          ...
          <li class=" nav-item"><a href="#"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.starter_kit.main">Email Configuration</span></a>
      ...
      <!--   <li {{{ (Request::is('admin/commision*') ? 'class=active' : '') }}}>
       ...
       <!--  <li {{{ (Request::is('admin/referral-lists*') ? 'class=active' : '') }}}>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-star"></i><span class="menu-title" data-i18n="nav.starter_kit.main">Ratings</span></a>
             <ul class="menu-content">
       ...
       <li {{{ (Request::is('admin/reports') ? 'class=active' : '') }}}>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-ticket"></i><span class="menu-title" data-i18n="nav.starter_kit.main">Coupon Codes</span></a>
             <ul class="menu-content">
