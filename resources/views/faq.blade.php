...
<div class="container" style="margin-top: 35px;">
	<form action="{{BASE_URL}}faq-filter" method="post">
		...
		<label>Search</label>  
	    <input type="text" placeholder="Search here" list="states-2" id="search-2" data-list='{"valueCompletion": true, "highlight": true}' name="faq">
	...
	<p>
		...
		@foreach($data as $faq)
		<div class="border">
  			<span class="border_new">{{$faq->question}} <a  data-toggle="collapse" href="#{{$faq->id}}" role="button" aria-expanded="false" aria-controls="{{$faq->id}}"><i class="fa fa-plus-square"></i></a></span>
