...
<div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Property Blocking</h3> <span style="float:right"><button type="button" class="btn btn-outline-blue blue block btn-lg" data-toggle="modal" data-target="#rollIn">
                            Block Property
                          </button></span>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      ...
                                      <select id="property" name="property" class="form-control" onchange="get_blocked_date(this.value)" >
                                    ...
                                    <fieldset class="form-group floating-label-form-group">
                                      ...
                                      <input type="date" required name="block_date" value="" class="form-control pickadate" id="block_date" placeholder="Date">
                                    </fieldset>
                                    <fieldset class="form-group floating-label-form-group">
                                      <label for="email">Comments</label>
                                      <input type="text" required name="comment" class="form-control" id="comment" placeholder="Comments">
                                    </fieldset>
                                  </div>
                      ...
                      <thead> 
                        ...
                        @foreach($data as $key=> $d)
                            <tr>
                              ...
                              <td>{{$d->start_date}}</td>
                              <td>
                                <a class="btn btn-default btn-danger " href="delete-blocked-date/{{$d->id}}" style="color:white"><i class="fa fa-edit"></i>Delete</a>
                              </td>
                            </tr>
                        @endforeach
                        </tbody>
