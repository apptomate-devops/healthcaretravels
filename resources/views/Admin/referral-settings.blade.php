                        ...
                        <div class="col-md-6">
                          <div class="form-body">
                            <div class="form-group">
                              ...
                              <input type="text" id="eventInput1" class="form-control" placeholder="When Friend Guest" name="WhenFriendGuest" value="10">
                            </div>
                            <div class="form-group">
                              <label for="eventInput2">When Friend Host</label>
                              <input type="text" id="eventInput2" class="form-control" placeholder="When Friend Host" name="WhenFriendHost" value="20">
                            </div>  
