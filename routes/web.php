...
Route::get('/rental_analysis', 'HomeController@rental_analysis');
Route::post('/rental_analysis', 'HomeController@save_rental_analysis');
...
Route::middleware(['LoginCheck'])->group(function () {
    ...
    Route::middleware(['VerifiedCheck'])->group(function () {
        ...
        Route::POST('/owner/update_owner_funding_source_for_booking', 'PropertyController@update_owner_funding_source');
