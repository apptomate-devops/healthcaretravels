...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block"> Room Type Management</h3> <span style="float:right"><button
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-default btn-danger "
                                                       href="delete-room_type/{{$agency->id}}" style="color:white"><i
