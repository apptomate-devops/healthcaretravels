...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Property Type Management</h3> <span
                style="float:right"><button type="button" class="btn btn-outline-blue blue block btn-lg"
                                            data-toggle="modal" data-target="#rollIn">
                            Add Property Type
                          </button></span>
                        ...
                        <div class="modal-body">
                            <fieldset class="form-group floating-label-form-group">
                                ...
                                <input type="text" name="name" required value="{{$agency->name}}" class="form-control"
                                       id="name" placeholder="Property Type">
                            </fieldset>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-default btn-danger "
                                                       href="delete-property_type/{{$agency->id}}"
                                                       style="color:white"><i class="fa fa-edit"></i>Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
