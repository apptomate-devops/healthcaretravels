                  ...
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input type="text" id="projectinput4" class="form-control" placeholder="Email id" name="email">
                          </div>
                        </div>
                        ...
                        <div class="form-group row" class="col-md-6">
                          ...
                          @foreach($pages as $key => $page)
                            ...
                            <label for="switcherySize10" class="font-medium-2 mr-1">{{$page->page_name}}</label>
                <input type="checkbox" id="switcheryColor" data-size="xs" class="switchery" data-color="primary"
                      ...
                      <div class="form-actions center">
                        <a href="{{url('/admin/admin-users')}}" class="button btn btn-warning mr-5" style="padding: 10px 15px;">
