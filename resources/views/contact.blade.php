		...
		<div class="col-md-4">
			...
			<div class="sidebar-textbox">
				...
				<ul class="contact-details">
					...
					<li><i class="im im-icon-Globe"></i> <strong>Web:</strong> <span><a target="_blank" href="{{CLIENT_WEB}}">{{CLIENT_WEB}}</a></span></li>
					<li><i class="im im-icon-Envelope"></i> <strong>E-Mail:</strong> <span><a target="_blank" href="mailto:{{CLIENT_MAIL}}">{{CLIENT_MAIL}}</a></span></li>
				</ul>
			</div>
			<div class="">
		...
		<div class="col-md-8">
			...
			<section id="contact">
				...
				<div id="contact-message"></div>
					...
					<form method="post" action="{{URL('/')}}/contact_mail"  autocomplete="off" onsubmit="return form_validate();">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div>
								<input name="email" type="email" id="" placeholder="Email Address" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" required="required">
							</div>
						</div>
					</div>
					...
					<div>
						<textarea name="message" cols="40" rows="3" id="" placeholder="Message" spellcheck="true" required="required"></textarea>
					</div>

					<div class="g-recaptcha" data-sitekey="6LcdUVMUAAAAAHf1NDwJ5VG7s3AemNQbXuMHZBsR"></div><br>
