...
//define('BASE_URL', 'http://localhost:8080/keepers/');
define('APP_BASE_NAME', 'Health Care Travels');

define('APP_LOGO_URL', 'https://demo.rentalslew.com/public/keepers_logo.png');
define('TIMEZONE', 'Asia/Kolkata');

// define('BASE_URL', 'https://demo.rentalslew.com/');

define('BASE_URL', 'https://healthcaretravels.com/');
// define('BASE_URL', 'https://healthcaretravels.com/');

// define('BASE_URL', 'http://127.0.0.1/sparkout/rentalslew/');

define('BASE_COLOR', 'e88016');
//define('BASE_URL', 'http://localhost/rental-slew/');
...
define("DOUBLE_BED", "https://healthcaretravels.com/public/bedicons/King,-Queen,Double-Bed.png");
define("QUEEN_BED", "https://healthcaretravels.com/public/bedicons/King,-Queen,Double-Bed.png");
define("SINGLE_BED", "https://healthcaretravels.com/public/bedicons/Single.png");
define("SOFA_BED", "https://healthcaretravels.com/public/bedicons/Sofa.png");
define("BUNK_BED", "https://healthcaretravels.com/public/bedicons/Bunk-Bed.png");
define("COMMON_SPACE_BED", "https://healthcaretravels.com/public/bedicons/Couch.png");
