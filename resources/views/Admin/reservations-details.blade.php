        ...
        <section class="card">
          <div id="invoice-template" class="card-body">
           ...
           <!-- <div id="invoice-items-details" class="pt-2">
              ...
              <div class="row"> -->
                <div class="col-sm-12 text-center text-md-left">
                  <p class="lead">Reservation Details : &nbsp;<span class="btn btn-default btn-info">{{$data->title}}</span></p>
                  <div class="row">
                    <div class="col-md-8">
                      <table class="table " style="">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Nights:</td>
                            <td class="col-det">{{$data->total_days}}</td>
                          </tr>
                         ...
                         {{--  <tr>
                          ...
                          <tr>
                            ...
                            <td class="col-det">$ {{$data->total_days*$data->price_per_night}}</td>
                          </tr>
                          <tr>
                            <td>Service fee:</td>
                          ...
                          <tr>
                           ...
                           <tr>
                            ...
                            <td class="col-det">$ {{$data->total_amount - ($data->service_tax + $data->admin_commision)}}</td>
                          </tr>
                         <!--  <tr>
                            <td>Payment Mode:</td>
                      ...
                      <center>
                        ...
                        @if($data->booking_status == 3)
                          <div class="col-md-5 col-sm-12 text-center">
                            <button type="button" class="btn btn-info btn-lg my-1"> Invoice Sent</button>
                          </div>
                        @endif
                        @if($data->booking_status == 4)
                          <div class="col-md-5 col-sm-12 text-center">
                            <button type="button" class="btn btn-info btn-lg my-1"> Request Cancelled by owner</button>
                          </div>
                        @endif
                      </center>
                    </div>
