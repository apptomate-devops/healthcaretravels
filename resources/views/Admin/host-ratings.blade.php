...
<link rel="stylesheet" href="{{URL::asset('/css/icons.css')}}">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Host Ratings</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Host Ratings</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-head">
                  ...
                  <h4 class="card-title">Host Ratings</h4>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <div class="star-rating" >
                              ...
                              <input type="hidden" name="rating" class="rating-value" value="{{$d['rating']}}">
                          </div>
                          </td>
                         <!--  <td>
