...
<head>
  <title>
    Login to {{APP_BASE_NAME}} Admin Dashboard
  </title>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal form-simple" action="" method="post">
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="password" value="" class="form-control form-control-lg input-lg" id="user-password"
                      ...
                      <button type="submit" class="btn btn-info btn-lg btn-block" style="background-color: #{{BASE_COLOR}} !important; border-color: #{{BASE_COLOR}} !important;">
