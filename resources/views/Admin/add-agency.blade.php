...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Agency Management</h3> <span style="float:right"><button
                        ...
                        <div class="modal-body">
                            <fieldset class="form-group floating-label-form-group">
                                ...
                                <input type="text" name="name" required value="{{$agency->name}}" class="form-control"
                                       id="name" placeholder="Agency Name">
                            </fieldset>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-default btn-danger "
                                                       href="delete-agency/{{$agency->id}}" style="color:white"><i
