...
<div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Occupation Management</h3> <span style="float:right"><button type="button" class="btn btn-outline-blue blue block btn-lg" data-toggle="modal" data-target="#rollIn">
                            Add Occupation
                          </button></span>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      ...
                                      <input type="text" required name="name" value="" class="form-control" id="name" placeholder="Occupation Name">
                                    </fieldset>
                            ...
                            <div class="modal-dialog" role="document">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      <label for="email">Name</label>
                                      <input type="text" name="name" required value="{{$agency->name}}" class="form-control" id="name" placeholder="Occupation Name">
                                    </fieldset>
                          ...
                          @foreach($occupation as $key=> $agency)
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a class="btn btn-default btn-danger " href="delete-occupation/{{$agency->id}}" style="color:white"><i class="fa fa-edit"></i>Delete</a>
                              </td>
                            </tr>
@endforeach
                        </tbody>
