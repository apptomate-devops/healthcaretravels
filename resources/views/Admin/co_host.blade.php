                                ...
                                <table class="table table-striped table-bordered zero-configuration select" id="hct_users">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($traveller->approved_by))
                                                <a href="{{BASE_URL}}admin/single_user?id={{$traveller->id}}">
                                                    <span class="btn btn-outline-success btn-default btn-block">
                                                        Documents Approved
                                                    </span>
                                                </a>
                                                @else
                                                <a href="{{BASE_URL}}admin/single_user?id={{$traveller->id}}">
                                                    <span class="btn btn-success btn-default btn-block">View </span>
                                                </a>
                                                @endif
                                            </td>
                                            <td>
