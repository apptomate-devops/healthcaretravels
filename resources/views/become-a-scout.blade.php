        ...
        <div class="row">
            ...
            <!--Tab -->
                ...
                <div class="my-account style-1 margin-top-5 margin-bottom-40" id="login_form">
                    ...
                    <p>This is a form to be filled out by those who desire to Scout. If you want to know what a Scout is
                        refer to the FAQ section.</p>
                    <form method="post" class="register" action="{{url('/')}}/become-a-scout-save">
                        ...
                        <p class="form-row form-row-wide">
                            <label for="email2">Email Address:
                                ...
                                <input type="email" class="input-text validate" name="email" required id="email2"
                                       value=""/>
                            </label>
                        </p>
                        ...
                        <p class="form-row form-row-wide">
                            <label for="phone_no">Phone Number:
                                ...
                                <input type="text" class="input-text validate" name="phone_no" required id="phone_no"
                                       value=""/>
                            </label>
                        </p>
                        ...
                        <p class="form-row form-row-wide">
                            <label for="Firstname">Firstname:
                                ...
                                <input type="text" class="input-text validate" name="firstname" required id="Firstname"
                                       value=""/>
                            </label>
                        </p>
                        ...
                        <p class="form-row form-row-wide">
                            <label for="username2">Lastname:
                                <i class="im im-icon-Male"></i>
                                <input type="text" class="input-text validate" name="lastname" required id="lastname"
                                       value=""/>
                            </label>
                        </p>
                        ...
                        <p class="form-row form-row-wide">
                            <label for="State">What State is the City in?
                                <input type="text" class="input-text validate" name="state" id="State" required
                                       value=""/>
                            </label>
                        </p>
                        ...
                        <p class="form-row form-row-wide">
                            <label for="State">How many miles are you willing to travel? Ex: 40 miles or less
                                <input type="text" class="input-text validate" name="miles" id="miles" required
                                       value=""/>
                            </label>
                        </p>

                        <p class="form">
                            <label for="travel">We may ask for a Photo Copy, License Plate and or car description, so we
                                may know who is entering into host homes and who host should be expecting. Are you
                                willing to provide this information if we ask? *
                            </label>
                        ...
                        <p class="form-row" style="margin-top: 10px;">
                            <input type="submit" id="reg_button" class="button border fw margin-top-10" name="register"
                                   value="Submit"/>
                        </p>
