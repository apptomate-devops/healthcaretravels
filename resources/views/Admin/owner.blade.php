...
<div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Owner Management 
                        ...
                        <tbody>
                          ...
                          @foreach($travellers as $key => $traveller)
                            <tr>
                              ...
                              <td>
                                @if($traveller->email!='0'){{$traveller->email}}@else <center>-</center>@endif
                              </td>
                              <td>
                                  @if($traveller->phone!='0'){{$traveller->phone}}@else <center>-</center>@endif
                              </td>
                              <td>
                               @if($traveller->gender=!'0'){{$traveller->gender}}@else<center>-</center>@endif
                              </td>
                              <td>
                                  @if($traveller->date_of_birth!='0'){{date('d-m-Y',strtotime($traveller->date_of_birth))}}@else<center>-</center>@endif
                              </td>
                              <td>
                              ...
                              <td>
                                <fieldset class="form-group">
                                  <select class="form-control" onchange="status_update(this.value,{{$traveller->id}})" id="basicSelect" style="cursor: pointer;" >
