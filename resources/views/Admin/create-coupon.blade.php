                    ...
                    <form class="form form-horizontal" method="post">
                      ...
                      <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="coupon_name" class="form-control" placeholder="Coupon Name"
                            name="coupon_name">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="coupon_code" class="form-control" placeholder="Coupon Code"
                            name="coupon_code">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="max_no_users" class="form-control" placeholder="Enter Max users count" name="max_no_users">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="projectinput4" class="form-control" placeholder="Enter Amount or Percentge" name="price_value">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="date" id="coupon_valid_from" class="form-control" placeholder="Coupon valid from" name="coupon_valid_from">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="date" id="coupon_valid_to" class="form-control" placeholder="Coupon valid to" name="coupon_valid_to">
                          </div>
                        </div>
                      ...
                      <div class="form-actions center">
                        <a href="manage-couponcodes.html" class="button btn btn-warning mr-5" style="padding: 10px 15px;">
