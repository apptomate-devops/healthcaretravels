...
class Detect
{
    ...
    private static function getIp()
    {
        ...
        if (in_array(self::$ipAddress, ['::1', '127.0.0.1', 'localhost'])) {
    ...
    public static function ieCountdown($prependHTML = '', $appendHTML = '')
    {
        ...
        if (self::$detect->version('IE') !== false && self::$detect->version('IE') <= 9) {
            ...
            $ieCountdownHTML .=
                '" target="_blank"><strong>YOU ARE USING AN OUTDATED BROWSER</strong><br />It is limiting your experience.<br />Please upgrade your browser,<br />or click this link to read more.</a>' .
                $appendHTML;
        }
