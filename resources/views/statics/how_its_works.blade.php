@extends('layout.master') @section('title','Health Care Travels') @section('main_content')
    ...
    <div class="wpb_video_widget wpb_content_element vc_clearfix   vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left vc_video">
        <div class="wpb_wrapper">
            ...
            <div class="wpb_video_wrapper"><div class="video-container"><iframe width="1178" height="700" src="https://www.youtube.com/embed/oEJSStC-S0Y?feature=oembed" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div></div>
        </div>
    </div>
</div></div></div></div>
