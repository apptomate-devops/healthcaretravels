                        ...
                        <div class="col-md-9">
                          <div class="form-body">
                            <div class="form-group">
                              ...
                              <input type="text" id="eventInput1" class="form-control" placeholder="Admin Commission in %" name="admin_commision" value="{{$commision->admin_commision}}">
                            </div>
                            <div class="form-group">
                              <label for="eventInput2">Host Commission</label>
                              <input type="text" id="eventInput2" class="form-control" placeholder="Host Commission in %" name="host_commision" value="{{$commision->host_commision}}">
                            </div>                            
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-9">
                          <div class="form-body">
                            <div class="form-group">
                              ...
                              <input type="tel" id="eventInput5" class="form-control" name="deposit" placeholder="Enter Amount" value="{{$commision->deposit}}">
                            </div>
                          </div>
                        </div>
                      </div>
