          ...
          <section class="row">
            <div class="col-12">
                        ...
                        <tbody>
                          ...
                          @foreach($properties as $key => $property)
                            <tr>
                              ...
                              <td>
                                Featured : <input type="checkbox" id="switchery1" class="switchery-sm" @if($property->on_popular == 1) checked @endif/>
              ...
              @endif
                              ...
                              <td>
                                <a href="{{BASE_URL}}admin/property_details/{{$property->id}}"><span class="btn btn-success btn-default">View </span> </a>
                              </td>
                              <td style="min-width: 110px;">
                                <fieldset class="form-group">
                                  <select class="form-control" onchange="status_update({{$property->id}},this)" id="basicSelect" style="cursor: pointer;">
