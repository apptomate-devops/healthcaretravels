                    ...
                    <input type="hidden" name="role_id" value="0">
                      ...
                      <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="title2" value="{{isset($cancel->title)?$cancel->title:''}}" class="form-control" placeholder="Title"
                            name="title">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input required type="text" id="subject2" value="{{isset($cancel->subject)?$cancel->subject:''}}" class="form-control" placeholder="Subject"
                            name="subject">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <textarea name="message" class="form-control" id="message2">{{isset($cancel->message)?$cancel->message:''}}</textarea>
                          </div>
                        </div>
