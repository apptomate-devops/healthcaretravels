...
<div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block"> Room Type Management</h3> <span style="float:right"><button type="button" class="btn btn-outline-blue blue block btn-lg" data-toggle="modal" data-target="#rollIn">
                            Add Room Type
                          </button></span>
      ...
      <div class="modal animated rollIn text-left" id="rollIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel41" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form name="edit_agency" action="add_room_type_process" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">  
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title" id="myModalLabel41">Add Room Type</h4>
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      ...
                                      <input type="text" required name="name" value="" class="form-control" id="name" placeholder="Room Type">
                                    </fieldset>
 ...
 @foreach($room_types as $key=> $agency)
      <div class="modal animated rollIn text-left" id="rollIn{{$key+1}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel41" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form name="add_agency" action="add_room_type_process" method="post">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">  
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      <label for="email">Name</label>
                                      <input type="text" name="name" required value="{{$agency->name}}" class="form-control" id="name" placeholder="Room Type">
                                    </fieldset>
                          ...
                          @foreach($room_types as $key=> $agency)
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a class="btn btn-default btn-danger " href="delete-room_type/{{$agency->id}}" style="color:white"><i class="fa fa-edit"></i>Delete</a>
                              </td>
                            </tr>
@endforeach
                        </tbody>
