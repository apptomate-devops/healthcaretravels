...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Faq Management</h3> <span style="float:right"><button
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <fieldset class="form-group floating-label-form-group">
                            ...
                            <input type="text" required name="question" value="" class="form-control" id="question"
                                   placeholder="Question">
                        </fieldset>

                        <fieldset class="form-group floating-label-form-group">
                            <label for="email">Answer</label>
                            <textarea name="answer" required value="" class="form-control" id="answer"
                ...
                <form name="add_agency" action="add_faq_process" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <fieldset class="form-group floating-label-form-group">
                                <label for="email">Question</label>
                                <input type="text" name="question" required value="{{$f->question}}"
                                       class="form-control" id="question" placeholder=" question">
                            </fieldset>

                            <fieldset class="form-group floating-label-form-group">
                                <label for="email">Answer</label>
                                <textarea name="answer" required value="{{$f->question}}" class="form-control"
                                          id="answer" placeholder="Answer">{{$f->answer}}</textarea>
                            </fieldset>
                                        ...
                                        @foreach($faq as $key=> $f)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-default btn-danger " href="delete-faq/{{$f->id}}"
