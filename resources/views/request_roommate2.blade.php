                                ...
                                <div class="submit-section">
                                    ...
                                    <div class="row with-forms">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="chosen-select-no-single" name="is_house_on_healthcare" required="required">
                                    ...
                                    <div class="row with-forms">
                                        <div class="col-md-6">
                                           ...
                                           <input type="text" class="input-text validate" name="occupation" id="occupation" value="" required="required"/>                  
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row with-forms">
                                        <div class="col-md-6">
                                           ...
                                           <select class="chosen-select-no-single" name="prefer_gender" required="required">
                                                <option label="blank"></option>
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <select class="chosen-select-no-single" name="prefer_age" required="required">
                                                <option label="blank"></option>
                                    ...
                                    @if(!Session::has('user_id'))
                                        <center>
                                            <button id="button" onclick="location.href='{{BASE_URL}}/login';" class="button border margin-top-5">Login to Request Roommate  <i class="fa fa-arrow-circle-right"></i></button>
                                        </center><br><br>
                                    @else
                                        <center>
